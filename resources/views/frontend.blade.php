        ...
        <div class="container">
            <div class="navbar-header">
                <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse">
                    ...
                    href="/">Nesha Shafwana (5026231013)</a>
            </div>
                    ...
                    <ul class="filter font-alt" id="filters">
                        <li>
                            <a class="current wow fadeInUp" href="#" data-filter="*"
                                style="font-size: 20px; font-weight: 700">All</a>
                        </li>
                        <li>
                        ...
                        {{-- <li>
                            <a class="wow fadeInUp" href="#" data-filter=".other" data-wow-delay="0.6s"
                                style="font-size: 20px; font-weight: 500">Other</a>
                        </li> --}}
                    </ul>
                </div>
            </div>
